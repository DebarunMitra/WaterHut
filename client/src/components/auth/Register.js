...
const Register=({setAlert,register, isAuthenticated})=>{//prpps
  ...
  const onSubmit=async e=>{
    ...
    setAlert("Password does't match",'danger');//props.setAlert
      //console.log("");
    }
    else{
      //console.log('Success');
...
Register.propTypes ={
  ...
  const mapStateToProps=state=>({//process to redirection after login
